...
* O sistema deve permitir que o cliente adicione produtos disponíveis em seu carrinho de compras, cada produto em determinada quantidade e tipo. O cliente também poderá remover itens do carrinho e alterar suas quantidades. Para usar o carrinho, o cleinte deve estar logado em sua conta.
...
* O sistema dev permitir que o administrador edite suas informações de cadastro.
